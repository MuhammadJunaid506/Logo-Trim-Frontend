...
const RequirementsForm = () => {
    ...
    return (
        <ClientLayout head={{ title: "Requirement Form - LogoMagicians", description: "" }}>
            <Row style={{ backgroundColor: "#000", justifyContent: "center", minHeight: 200, alignItems: "center" , paddingTop:"80px"}}>
                <Col xs={22} md={20}>
                    {/* <h3 style={{ fontSize: 26, color: "#fff", textAlign: "center" }}>Thank You for Placing Your Order. Your payment has been duly received.</h3> */}
                    <p style={{ textAlign: "center", color: "#fff", fontSize: 15 }}>Discover unbeatable value with LogoTrim! Take a look at our pricing plans, which are custom-made to suit every budget and raise your brand effortlessly.</p>
                </Col>
            </Row>
