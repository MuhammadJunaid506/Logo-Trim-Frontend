        ...
        >
          ...
          <AntImage.PreviewGroup>
            ...
            <Col xs={24} md={12} style={{ background: "#3a3c3d", padding: "55px 45px", textAlign: "left", justifyContent:"center" }}>
                <Typography.Title level={2} style={{ fontSize: "35px", color: "#fff",marginTop:90, fontWeight: "bolder" }}>{<>The most Recognizable  <span style={{color:"#fe1f07"}}>Logo, App, and Web Development Firm</span></>}</Typography.Title>
                <Typography style={{ fontSize: 12, color: "#6A6A6A", margin: "5px 0", fontWeight: 700 }}>We are Keen on excellence. Our dynamic team will pursue it in every aspect of our client's work. With a passion for modernization and a promise of quality, we strive to surpass expectations and drive positive change. Our task is to stimulate users through creativity and collaboration.</Typography>
