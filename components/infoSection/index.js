...
const InfoSection = ({title,description}) => {
  return (
    ...
    <div className="tekoFont" style={{width:'100%', padding:'30px 50px', borderRadius:'10px', display:'flex' , justifyContent:"center" , flexDirection:'column' , alignItems:'flex-end'}}>
     ...
     <p style={{color:"white", fontSize:'30px' , fontWeight:'normal' ,marginBottom:0}}>1 (917) 914-2837</p>
     </div>
    </div>
    </Col>
    <Col xs={24} lg={13} style={{transform: 'skew(20deg)'}}> 
    <div className="tekoFont slantedDiv" style={{width:'100vw', padding:'30px 50px', background:"#fe1f07" , borderTopLeftRadius:'15px', borderBottomLeftRadius:"15px", marginBottomLeft:"10px" , display:'flex' , justifyContent:"center" , flexDirection:'column' , alignItems:'flex-start', TextDecoration:"none"}}>
