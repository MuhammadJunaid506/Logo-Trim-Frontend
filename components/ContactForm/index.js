              ...
              <div style={{ minHeight: "120px" }}>
                <Row>
                  ...
                  <Col xs={24} lg={17}>
                    ...
                    >
                      Savvy enterprises require intelligent digital solutions. Explore the range of services we can provide for your company.
                    </Typography.Text>
                  </Col>
                </Row>
              </div>
              ...
              <div style={{ minHeight: "120px" }}>
                <Row>
                  ...
                  <Col xs={24} lg={16}>
                    ...
                    >
                      Smart businesses seek astute digital solutions. Discover more about the services available for your company.
                    </Typography.Text>
                  </Col>
                </Row>
              </div>
            ...
            <div style={{ minHeight: "120px" }}>
              <Row>
                ...
                <Col xs={24} lg={16}>
                  ...
                  >
                    We excel in innovative methods, novel concepts, and exceptional website creations.
                  </Typography.Text>
                </Col>
              </Row>
              </div>
              ...
              <Row>
                ...
                <Col xs={24} lg={16}>
                  ...
                  >
                    Our expertise lies in innovative strategies, novel concepts, and distinctive websites.
                  </Typography.Text>
                </Col>
              </Row>
              </div>
        ...
        <Col xs={24} lg={15}>
          ...
          >
            ...
            >
              ...
              Experienced professionals with the appropriate skill set and extensive exposure will ensure innovative and exceptional product design to establish it as a rising brand. We've achieved a 99% customer satisfaction 
              </p> 
    
              <p style={{ color: "black",fontSize:'12px', fontWeight:700 }}>
                <><span style={{ color: "red", textDecoration:"underline" }}>99% Customer Satisfaction</span>  rate based on 750+ reviews and 20,000 unbiased resources.</>
            ...
            <h3 style={{ fontSize:"14px", marginLeft:"50px" , color:"#fe1f07" ,fontFamily:"Lato",lineHeight:0.1}}>Want to create something Innovative?</h3>
            <h3 style={{ fontSize:"30px", marginLeft:"50px", fontFamily:"Teko",fontWeight:"bolder"  }}>Send us a message. </h3>
              <Form
                form={contactForm}
                name="normal_login"
